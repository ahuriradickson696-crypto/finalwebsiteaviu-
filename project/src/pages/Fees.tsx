...
export function Fees() {
  ...
  return (
    <div className="page-content">
      ...
      <section className="section-pad">
        <h2 style={{ marginBottom: 12 }}>International students — currency helper</h2>
        <p style={{ marginBottom: 16, color: 'var(--ink-soft)', maxWidth: 640 }}>
          Convert amounts for planning only. Official AVIU fee schedules will be published by the Bursar — this widget does not replace them.
        </p>
        <CurrencyConverter />
      </section>

...
export function Home() {
  ...
  return (
    <div className="page-content">
      <section className="hero">
        <div className="hero-copy">
          ...
          <div className="hero-buttons">
            <button className="button button-primary" onClick={() => navigate('/programs')}>
          ...
          <div className="hero-note">
            ...
            <span>
              January · May · August<br />
              intakes open — apply today
            </span>
          </div>
        </div>
      ...
      <section className="program-search-widget section-pad">
        <div className="program-search-inner">
          <div>
            <div className="eyebrow"><span className="eyebrow-line" /> Programs</div>
            <h2>Find your <em>program</em> instantly.</h2>
            <p>Search the CEBAT-aligned catalogue — Education, Business &amp; ICT, Nursing, Social Sciences.</p>
          </div>
          <div className="program-search-actions">
            <button type="button" className="button button-primary" onClick={() => navigate('/programs/course-finder')}>
              Open Course Finder
            </button>
            <button type="button" className="button button-outline" onClick={() => navigate('/programs')}>
              Browse all programs
            </button>
          </div>
        </div>
      ...
      <section className="experience-section section-pad" id="experience">
        ...
        <div className="feature-grid">
          ...
          <div className="feature-stat">
            ...
            <strong>NCHE</strong>
            <p>Accredited institution — verify at unche.or.ug. Nabweru campus, Wakiso.</p>
            <a
              onClick={(e) => {
                e.preventDefault();
                navigate('/programs');
